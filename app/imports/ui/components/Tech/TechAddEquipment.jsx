...
const TechAddEquipment = () => {
  ...
  return ready ? (
    <>
      <CircleButton onClick={handleShow} variant="dark" id="add-tech-equipment" tooltip="Add Equipment">
        <Plus fontSize="25px" id="add-tech-equipment" />
      </CircleButton>
      <Modal show={show} onHide={handleClose} id="add-tech-equipment-form">
        ...
        <Modal.Body>
          ...
          <AutoForm ref={ref => { fRef = ref; }} schema={bridge} onSubmit={data => submit(data, fRef)} onChange={(key, value) => { setRoom(value); }}>
            <SelectField
              name="rooms"
              options={roomList}
              id="add-tech-equipment-form-rooms"
            />
            <TextField name="quantity" id="add-tech-equipment-form-quantity" />
            <TextField name="description" id="add-tech-equipment-form-description" />
            <TextField name="serialNumber" id="add-tech-equipment-form-serialnumber" />
            <TextField name="assetTag" id="add-tech-equipment-form-assettag" />
            <Button type="submit" id="add-tech-equipment-form-submit" variant="success">Add</Button>
            <ErrorsField />
        ...
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={handleClose}
            id="add-tech-equipment-form-close-button"
          >
            Close
          </Button>
        </Modal.Footer>
